                    ...
                    <div class="w-full">
                        ...
                        <form action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="date" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" id="date" name="date" required>
                            </div>
