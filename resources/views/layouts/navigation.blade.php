                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('assign.index')" :hover="request()->routeIs('assign.index')">
                                        {{ __('Apply Assign Mualaf') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('assign.list')" :hover="request()->routeIs('assign.list')">
                                        {{ __('Listed Assigned') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-dropdown-link :href="route('performance.list')" :hover="request()->routeIs('performance.list')">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('mualaf.index')" :hover="request()->routeIs('mualaf.index')">
                                        {{ __('Mualaf Registration') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('madu.index')" :hover="request()->routeIs('madu.index')">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('assign.listMentor')" :hover="request()->routeIs('assign.listMentor')">
                                        {{ __('Mualaf list') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('assign.listPerformance')" :hover="request()->routeIs('assign.listPerformance')">
