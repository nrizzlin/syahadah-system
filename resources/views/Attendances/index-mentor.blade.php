                                            ...
                                            <div class="table-row">
                                                <form action="{{ route('clock-in') }}" method="post">
                                                    ...
                                                    <div class="flow-root px-4 py-2">
                                                        <label>
                                                            <input class="rounded" type="checkbox" name="tasks[]" value="Meeting up with Mualaf">
                                                            Meeting up with Mualaf
                                                        </label>
                                                        <br>            
                                                        <label>
                                                        ...
                                                        <br>
                                                        <label>
                                                            <input  class="rounded" type="checkbox" name="tasks[]" value="Consult with Mualaf"> 
                                                            Consult with Mualaf
                                                        </label>
                                                    </div>
